...
import co.unicauca.workflow.degree_ptoject.presentation.DocenteController;
import co.unicauca.workflow.degree_ptoject.presentation.EstudianteController;
...
public class main extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Parent root = loadFXML("/co/unicauca/workflow/degree_ptoject/view/signin.fxml");
    ...
    public static void setRoot(String name) throws IOException {
        String path = "/co/unicauca/workflow/degree_ptoject/view/" + name + ".fxml";
